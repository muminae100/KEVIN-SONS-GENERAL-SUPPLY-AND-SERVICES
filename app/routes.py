...
ResetPasswordForm,AddCareerForm,UpdateCareerForm)
from flask_mail import Message
from app.models import Users,Careers,Company
...
def admin_home():
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('admin_home'))
    return render_template('admin/admin_home.html', careers=careers,title='Admin panel',form=form)
...
def update_career(id):
    ...
    if form.validate_on_submit():
        ...
        if career:
            ...
            return redirect(url_for('admin_home'))
    return render_template('admin/admin_update_career.html', form = form)
